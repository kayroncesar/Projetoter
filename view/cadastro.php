...
if(isset($_POST['cadastro']))
{
    ...
    if($result) {
        // Imprime um script JavaScript para exibir um alerta
        echo "<script>alert('Tênis cadastrado com sucesso!');</script>";
    } else {
        echo "Erro ao cadastrar o tênis: " . mysqli_error($conexao);
    }
}
?>
...
<body>
    ...
    <input type="text" name="tamanho" id="tamanho" maxlength="5" size="20">
